    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <PDFDownloadLink
            document={<EvaluationReport evaluation={adaptEvaluationForReport(evaluation)} />}
            fileName={`evaluacion-${params.id}.pdf`}
          >
            {(props) => (
              <Button disabled={props.loading} className="gap-2">
                <FileDown className="w-4 h-4" />
                {props.loading ? "Generando..." : "Descargar PDF"}
              </Button>
            )}
          </PDFDownloadLink>
